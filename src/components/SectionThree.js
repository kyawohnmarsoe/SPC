    ...
    render() {
        ...
        return (
            <div>
             ...
             { this.state.central && <img src="./assets/img/maps/central.png" alt="" className="img-fluid map-img" /> }
             { this.state.north && <img src="./assets/img/maps/north.png" alt="" className="img-fluid map-img" /> }
             { this.state.south && <img src="./assets/img/maps/south.png" alt="" className="img-fluid map-img" /> }
             { this.state.east && <img src="./assets/img/maps/east.png" alt="" className="img-fluid map-img" /> }
             { this.state.west && <img src="./assets/img/maps/west.png" alt="" className="img-fluid map-img" /> }
            </div>
            ...
            { this.state.central &&
                <table className="table table-striped" id="central-locations">
                    <thead>
                        ...
                        <th scope="col"><img src="./assets/img/logos/choices.png" alt="" className="table-logo" /></th>
                        <th scope="col" className="right-space"><img src="./assets/img/logos/speedycare.png" alt="" className="table-logo" /></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <td className="right-border"><img src="./assets/img/check.png" alt="" className="table-check" /></td>
                        ...
                        <td className="right-border"><img src="./assets/img/check.png" alt="" className="table-check" /></td>
                        <td className="right-space"><img src="./assets/img/check.png" alt="" className="table-check" /></td>
                        </tr>
                        <tr>
